...
void bot_command_cast(Client* c, const Seperator* sep)
{
	...
	if (helper_is_help_or_usage(sep->arg[1])) {
		...
		p.examples_two =
		{
			...
			"invis: ^cast invisibility help",
			"resists: ^cast resistbuffs help",
			"rune: ^cast rune help",
			"lev: ^cast levitate help",
			"dispels: ^cast dispels help",
			"water: ^cast waterbreathing help",
			"size: ^cast size help",
			"pets: ^cast petresistbuffs help",
			"speed: ^cast movementspeed help"
		};
		p.examples_three =
		{
			"Subtargets:",
